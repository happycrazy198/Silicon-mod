//planet Zuila
const tartarusgen = extend(PlanetGenerator, {
    rawHeight(position){
...
tartarusgen.rid = new Packages.arc.util.noise.RidgedPerlin(1, 2);
tartarusgen.basegen = new BaseGenerator();
tartarusgen.scl = 5;
tartarusgen.waterOffset = 0.07;
tartarusgen.water = 2 / tartarusgen.arr[0].length;

const tartarus = new JavaAdapter(Planet, {}, "tartarus", Planets.sun, 3, 1);
tartarus.generator = tartarusgen;
tartarus.startSector = 1;
tartarus.hasAtmosphere = true;
tartarus.atmosphereColor = Color.valueOf("f0e4a8");
tartarus.meshLoader = () => new HexMesh(tartarus, 6);
//endregion planet Zuila
//Zuila sector presets
const siliconlands = new SectorPreset("siliconlands", tartarus, 1);
siliconlands.difficulty = 2;
siliconlands.captureWave = 20;

const siliconfields = new SectorPreset("siliconfields", tartaru, 1);
siliconfields.difficulty = 1;
siliconfields.captureWave = 10;


module.exports = {
    tartarus: tartarus,
  siliconfields: siliconfields,
  siliconlands: siliconlands
}